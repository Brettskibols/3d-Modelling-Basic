...
//
// Rotation Matrix that takes all X, Y and Z rotation Matrices and multiplies them so just 1 matrix can be called to rotate by EVERYTHING
//
Matrix Matrix::Rotate(float rotateOnX, float rotateOnY, float rotateOnZ)
{
	return Matrix::RotateMatrixX(rotateOnX) * Matrix::RotateMatrixY(rotateOnY) * Matrix::RotateMatrixZ(rotateOnZ);
}

//
// X axis rotation standalone Matrix 
//
Matrix Matrix::RotateMatrixX(float angle)
{
	return Matrix { 1,         0,           0,        0,
...
//
// Y axis rotation standalone Matrix
//
Matrix Matrix::RotateMatrixY(float angle)
{
...
//
// Z axis rotation standalone 
//
Matrix Matrix::RotateMatrixZ(float angle)
{
...
Matrix Matrix::_transfrormationMatrix()
{
	return Matrix();
}
